    ...
    <div className="min-h-[calc(100vh-3.5rem)] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-[var(--accent)] text-white font-bold text-lg mb-3">SB</div>
          <h1 className="font-display text-xl font-semibold text-[var(--text-primary)]">Seawolf Alumni</h1>
          <p className="text-sm text-[var(--text-muted)] mt-1">SBU graduates only</p>
        </div>
